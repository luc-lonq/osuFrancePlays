    ...
    <div class="w-full max-w-screen-xl mx-auto p-4 md:py-8">
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            ...
            <ul class="flex flex-wrap items-center mb-6 text-sm font-medium text-gray-500 sm:mb-0 dark:text-gray-400">
                ...
                <li>
                    <a href="/staff" class="hover:underline me-4 md:me-6">Staff</a>
                </li>
                <li class="me-4 md:me-6">
                    <a href="{{ env('DISCORD') }}" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                ...
                <li class="me-4 md:me-6">
                    <a href="{{ env('TWITTER') }}" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
